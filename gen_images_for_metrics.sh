...
CUDA_VISIBLE_DEVICES=$devices python generate_eval_images.py --dont_encode_text --dont_transform_image --run_idx $run_idx --input_image_size 32 --trained_model $trained_model