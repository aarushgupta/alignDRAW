...
CUDA_VISIBLE_DEVICES=$devices python visualize_val.py --dataset_name coco --model_name tti --input_image_size 32 --n_channels 3 --run_idx $run_idx  --T 200 --custom_sentence "A dog chasing after a human" --trained_model $trained_model
